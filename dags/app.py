...
headers = {
    ...
    "Sec-Ch-Ua": '"Not.A/Brand";v="8", "Chromium";v="116", "Microsoft Edge";v="116"',
    "Sec-Ch-Ua-Mobile": "?0",
    "Sec-Ch-Ua-Platform": "Windows",
    'User-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5845.96 Safari/537.36 Edg/116.0.1938.69'
}
